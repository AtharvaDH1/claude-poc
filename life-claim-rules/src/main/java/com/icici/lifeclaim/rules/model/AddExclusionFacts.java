...
public class AddExclusionFacts {
    ...
    public void setClaimReceivedValues(List<String> claimReceivedValues) {
        this.claimReceivedValues = claimReceivedValues != null ? claimReceivedValues : new ArrayList<>();
    }
    ...
    public void setInactivePolicyStatusValues(List<String> inactivePolicyStatusValues) {
        this.inactivePolicyStatusValues =
            inactivePolicyStatusValues != null ? inactivePolicyStatusValues : new ArrayList<>();
    }
    ...
    public void setTopAdvisorValues(List<String> topAdvisorValues) {
        this.topAdvisorValues = topAdvisorValues != null ? topAdvisorValues : new ArrayList<>();
    }
    ...
    public void setPartnerExclusionValues(List<String> partnerExclusionValues) {
        this.partnerExclusionValues =
            partnerExclusionValues != null ? partnerExclusionValues : new ArrayList<>();
    }
    ...
    public void setProductNormsValues(List<String> productNormsValues) {
        this.productNormsValues = productNormsValues != null ? productNormsValues : new ArrayList<>();
    }
    ...
    public void setUlipPolicyValues(List<String> ulipPolicyValues) {
        this.ulipPolicyValues = ulipPolicyValues != null ? ulipPolicyValues : new ArrayList<>();
    }
}
